...
def getMatch(birthdays):
    """Returns the date object of a birthday that occurs more than once in the birthdats list."""
...
for i in range(100_000):
    # Report on the progess every 10,000 simulations:
    if i % 10_000 == 0:
